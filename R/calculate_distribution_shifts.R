...
#'
#' @param abund model predictions, output from \code{make_predictions} as a rasterStack. Layers need names that correspond to the time stamps represented.
#' @param area_threshold a value between 0 and 1, defaults to 0.75. The total area of grid cells with the probability of occurrence of a species equal to or above this threshold will be calculated.
